...
def train_model(
    ...
    # Tensorboard root name of the logging directory writer = SummaryWriter(logdir='scalar/tutorial')
    ...
    with open(tensorboard_root + '/logdir.txt', 'w') as f:
      f.write(os.path.join(tensorboard_root, "bert_lightning_kubeflow"))


if __name__ == "__main__":
    train_model("/home/kumar/Desktop/KUBEFLOW/pytorch-pipeline/data_prep_step/bert/data/test", os.getcwd(),
                1, 15, 16, 3, 0.001, None, os.getcwd())
